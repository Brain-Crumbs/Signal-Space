...
## Evidence in this export

The selected run and classification are identified by README.md and export.json. Inspect results/tables/checks.json, results/tables/analysis.json and results/data/plot-data/summary.json. Figures have exact plot data and four-part interpretations. The companion prerequisite is cross-referenced by its run ID above and is included in the same repository PR.
